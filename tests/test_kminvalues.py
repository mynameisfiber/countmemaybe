...
def test_constructor():
    KMinValues(list(range(50)))
    KMinValues(list(range(50)), k=50)
    KMinValues(k=10)
    KMinValues()
...
def test_update():
    t1 = KMinValues(k=15)
    t1.update(list(range(10)))
    assert len(t1.kmin) == 10


def test_jaccard():
    # k == 400 => relative error of ~0.05
    t1 = KMinValues(list(range(500)), k=256)
    t2 = KMinValues(list(range(100, 500)), k=256)
...
def test_union():
    t1 = KMinValues(list(range(10)), k=5)
    t2 = KMinValues(list(range(10)), k=5)
    t3 = KMinValues(list(range(20)), k=5)
    ...
    t4 = KMinValues(list(range(40, 50)), k=5)
    t5 = t4 + t1
